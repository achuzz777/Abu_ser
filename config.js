...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'MADE BY XACHUZZ' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '917025994178@s.whatsapp.net' : process.env.TAG_REPLY,
    ABU: process.env.NAME_STYLE === undefined ? 'xachuzz' : process.env.NAME_STYLE,
    ...
    BOTABU: process.env.BOTV2_NAME === undefined ? '  Xachuzz࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOTV2_NAME,
    ...
    INSTA: process.env.INSTA_LINK === undefined ? 'https://instagram.com/xachuzz' : process.env.INSTA_LINK,
    GROUP: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/Bq0eHs3UpGJ2BKIHOmy7mk' : process.env.GROUP_LINK,
    LOGO: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/65610d29eb9e426d0f6c9.jpg' : process.env.ALL_IMG,
    YAK: process.env.YAK === undefined ? '918281714328,0' : process.env.YAK,
    OA_NAME: process.env.DEPLOYER === undefined ? 'Abhinave Suresh' : process.env.DEPLOYER,
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'Xachuzz' : process.env.OWNER_SHIP,
    MWOL: process.env.BGM_DURATION === undefined ? '7280542' : process.env.BGM_DURATION,
    BOT: process.env.BOT_NAME === undefined ? 'xachuzz࿐' : process.env.BOT_NAME,
    ...
    LOGO_NAME: process.env.ALL_NAME === undefined ? 'xachuzz࿐' : process.env.ALL_NAME,
